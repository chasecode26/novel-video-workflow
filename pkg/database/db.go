...
5. 镜头语言：
请只返回中文图像提示词，不要添加任何解释或其他内容。`,
			StyleAddon:     ", 中国传统节日风格, 背景以温暖的金色调为主，渐变融合梦幻的蓝色和紫色，增强了神秘的氛围，红色烟花和装饰元素点缀下半部分，粗体金色书法写着“金马贺岁”，凸显主题，下方用优雅字体书写“Happy New Year”和“贰零贰陆（2026）”，顶部包含表示从蛇年（乙巳年）过渡到马年（丙午年）的中文字符，右侧竖幅用英文写着“New Year”，圆形印章样式的设计增添了传统韵味，整体构图融合了神话、艺术和文化象征，庆祝节日盛典。大红色金色银色主色调, 贺岁元素, 2026年份标识, 丙午年干支纪年, 福字装饰, 红包元素, 祥云图案, 如意造型, 鞭炮装饰, 金元宝财富象征, 马的艺术字体设计, 剪纸工艺, 年画技法, 书法艺术, 吉祥图案, 喜庆祥和, 节日氛围浓厚, 传统工艺美术, 中国结装饰",
